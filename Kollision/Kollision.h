...
bool TestOBBOBB_V2(const OBB& a, const OBB& b) {
	Vektor3D D = a.center() - b.center();
...
bool TestOBBOBB_V3(const OBB& a, const OBB& b) {
	Vektor3D D = a.center() - b.center();
...
// mit Zwischenspeicherung
// ohne Kreuzprodukt
bool TestOBBOBB_V4(const OBB& a, const OBB& b) {
	Vektor3D D = a.center() - b.center();
...
// Seperating Axis Theorem speziell für OBBs
// mit Zwischenspeicherung
// OBBs ohne die uz Achse
bool TestOBBOBB_V4(const OBB_V2& a, const OBB_V2& b) {
	Vektor3D D = a.center() - b.center();
...
bool TestOBBOBB_V4(const OBB_V4& a, const OBB_V4& b) {
	Vektor3D D = a.center() - b.center();
	...
	Vektor3D a_uz(a_mat[0][2], a_mat[1][2], a_mat[2][2]);

	Vektor3D b_ux(b_mat[0][0], b_mat[1][0], b_mat[2][0]);
	Vektor3D b_uy(b_mat[0][1], b_mat[1][1], b_mat[2][1]);
	Vektor3D b_uz(b_mat[0][2], b_mat[1][2], b_mat[2][2]);
...
bool TestOBBOBB_V5(const OBB& a, const OBB& b) {
	Vektor3D D = a.center() - b.center();
...
// ohne Kreuzprodukt
// robust gegen NAN
bool TestOBBOBB_V6(const OBB& a, const OBB& b) {
	Vektor3D D = a.center() - b.center();
