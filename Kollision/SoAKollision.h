...
void SoA_OBB_Test_1vAll(const SIMDOBB& a, const OBBs& b, float* results) {
	...
	for (; i < b.length; ++i) {
		...
		SIMDOBB temp(
			SIMDPoint3D(b.cx[i], b.cy[i], b.cz[i]),
			SIMDVektor3D(b.uxx[i], b.uxy[i], b.uxz[i]),
			SIMDVektor3D(b.uyx[i], b.uyy[i], b.uyz[i]),
			SIMDVektor3D(b.uzx[i], b.uzy[i], b.uzz[i]),
...
void SoA_OBB_Test_1v1(const OBBs& a, const OBBs& b, float* results) {

	for (int64_t i = 0; i < b.length; i += 8) {

		__m256 cx_a = _mm256_load_ps(a.cx.get() + i);
		__m256 cy_a = _mm256_load_ps(a.cy.get() + i);
		__m256 cz_a = _mm256_load_ps(a.cz.get() + i);

		__m256 uxx_a = _mm256_load_ps(a.uxx.get() + i);
		__m256 uxy_a = _mm256_load_ps(a.uxy.get() + i);
		__m256 uxz_a = _mm256_load_ps(a.uxz.get() + i);

		__m256 uyx_a = _mm256_load_ps(a.uyx.get() + i);
		__m256 uyy_a = _mm256_load_ps(a.uyy.get() + i);
		__m256 uyz_a = _mm256_load_ps(a.uyz.get() + i);

		__m256 uzx_a = _mm256_load_ps(a.uzx.get() + i);
		__m256 uzy_a = _mm256_load_ps(a.uzy.get() + i);
		__m256 uzz_a = _mm256_load_ps(a.uzz.get() + i);

		__m256 ex_a = _mm256_load_ps(b.ex.get() + i);
		__m256 ey_a = _mm256_load_ps(b.ey.get() + i);
		__m256 ez_a = _mm256_load_ps(b.ez.get() + i);
		...
		_mm256_storeu_ps(results + i, res4_1);
	}
}